...
des.A2 <- matrix(c(rep(c(0.02, 0),1),rep(c(30.00, 0),1),
                   rep(c(0.02, 60),2),rep(c(30.00, 60),3)), ncol = 2, byrow = TRUE)


des.A3 <- matrix(c(rep(c(0.02, 0),1),rep(c(30.00, 0),2),
                   rep(c(0.02, 60),2),rep(c(30.00, 60),2)), ncol = 2, byrow = TRUE)


des.A4 <- matrix(c(rep(c(0.02, 0),2),rep(c(30.00, 0),2),
...
#des.delta1=des.delta2=des.delta3 (therefore we run the simulation for one of them)
...
#des.delta7=des.delta71=des.delta72
...
Table3 <- rbind( as.vector(t(res.A1)), as.vector(t(res.A2)),as.vector(t(res.A3)),
