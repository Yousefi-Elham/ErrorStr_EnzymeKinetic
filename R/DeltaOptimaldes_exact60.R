...
#----------------------------------------------------------------------------------------------
#delta1, when the tuning parameter r=1
set.seed(123456789) 
des.delta1.Big <- od_delta_KL_Example2(th0E2, th0E2 - s0E2, th0E2 + s0E2, 
                                       th1E2, th1E2 - s1E2, th1E2 + s1E2, XE2, n = 60, t.max = 600)$xi.best

#delta2, r=2
set.seed(123456789) 
des.delta2.Big <- od_delta_KL_Example2(th0E2, th0E2 - 2*s0E2, th0E2 + 2*s0E2, 
                                       th1E2, th1E2 - 2*s1E2, th1E2 + 2*s1E2, XE2, n = 60, t.max = 600)$xi.best

#delta3, r=3
set.seed(123456789) 
des.delta3.Big <- od_delta_KL_Example2(th0E2, th0E2 - 3*s0E2, th0E2 + 3*s0E2, 
                                       th1E2, th1E2 - 3*s1E2, th1E2 + 3*s1E2, XE2, n = 60, t.max = 600)$xi.best

#delta4, r=4
set.seed(123456789)
des.delta4.Big <- od_delta_KL_Example2(th0E2, th0E2 - 4*s0E2, th0E2 + 4*s0E2, 
                                       th1E2, th1E2 - 4*s1E2, th1E2 + 4*s1E2, XE2, n = 60, t.max = 600)$xi.best
...
set.seed(123456789)
des.delta5.Big <- od_delta_KL_Example2(th0E2, c(1.4345, 0.00,  0.2948), th0E2 + 5*s0E2, 
                                       th1E2, th1E2 - 5*s1E2, th1E2 + 5*s1E2, XE2, n = 60, t.max = 600)$xi.best

#alternative b) to avoid negative lower bands, when the tuning parameter r=5
set.seed(123456789) 
des.delta51.Big <- od_delta_KL_Example2(th0E2, c(1.4345, 0.00,  0.2948), c(10.6945,  7.288,  6.3358), 
                                        th1E2, th1E2 - 5*s1E2, th1E2 + 5*s1E2, XE2, n = 60, t.max = 600)$xi.best

#alternative c) to avoid negative lower bands, when the tuning parameter r=5
set.seed(123456789)
des.delta52.Big <- od_delta_KL_Example2(th0E2, c(1.4345, 1.079830,  0.2948), c(10.6945,  9.962444,  6.3358), 
                                        th1E2, th1E2 - 5*s1E2, th1E2 + 5*s1E2, XE2, n = 60, t.max = 600)$xi.best

#----------------------------------------------------------------------------------------------
# the bounds for parameters for r=6 contain negative values so we used 3 alternatives
th0E2 - 6*s0E2
th0E2 + 6*s0E2
...
#alternative a) to avoid negative lower bands, when the tuning parameter r=6
set.seed(123456789)
des.delta6newa.Big <- od_delta_KL_Example2(th0E2, c(0.5085, 0, 0), th0E2 + 6*s0E2, 
                                           th1E2, c(0, 0, 0.3364), th1E2 + 6*s1E2, XE2, n = 60, t.max = 600)$xi.best

#alternative b) to avoid negative lower bands, when the tuning parameter r=6
set.seed(123456789)
des.delta6newb.Big <- od_delta_KL_Example2(th0E2, c(0.5085, 0, 0), (th0E2 + 6*s0E2)+c(0, 1.0929, 0.3093), 
                                           th1E2, c(0, 0, 0.3364), (th1E2 + 6*s1E2)+c(0.3193, 0.8967, 0), XE2, n = 60, t.max = 600)$xi.best

#alternative c) to avoid negative lower bands, when the tuning parameter r=6
set.seed(123456789)
des.delta6newc.Big <- od_delta_KL_Example2(th0E2, c(2.4261, 0.8647, 1.1110), c(15.1591, 12.4413, 9.8932), 
                                           th1E2, c(4.3032, 2.8270, 2.2111), c(33.5330, 25.7731, 14.5080), XE2, n = 60, t.max = 600)$xi.best
...
set.seed(123456789)
des.delta6.Big <- od_delta_KL_Example2(th0E2, c(0.00, 0.00, 0.00), th0E2 + 10*s0E2, 
                                       th1E2, c(0.00, 0.00, 0.00), th1E2 + 10*s1E2, XE2, n = 60, t.max = 600)$xi.best

#alternative b) to avoid negative lower bands, when the tuning parameter r=10
set.seed(123456789)
des.delta61.Big <- od_delta_KL_Example2(th0E2, c(0.00, 0.00, 0.00), c(18.52,  14.576,  12.082), 
                                        th1E2, c(0.00, 0.00, 0.00), c(41.106, 31.442,  17.758), XE2, n = 60, t.max = 600)$xi.best

#alternative c) to avoid negative lower bands, when the tuning parameter r=10
set.seed(123456789)
des.delta62.Big <- od_delta_KL_Example2(th0E2, c(1.3172328, 0.3555085, 0.5360061), c(27.92078, 30.26016, 20.50576), 
                                        th1E2, c(5.557143,  3.634513,  1.949351), c(25.96661,  20.04714,  16.45605), XE2, n = 60, t.max = 600)$xi.best
...
set.seed(123456789)
des.delta7.Big <- od_delta_KL_Example2(th0E2, c(0.00, 0.00, 0.00), th0E2 + 15*s0E2, 
                                       th1E2, c(0.00, 0.00, 0.00), th1E2 + 15*s1E2, XE2, n = 60, t.max = 600)$xi.best

#alternative b) to avoid negative lower bands, when the tuning parameter r=15
set.seed(123456789)
des.delta71.Big <- od_delta_KL_Example2(th0E2, c(0.00, 0.00, 0.00), c(27.780,  21.864,  18.123), 
                                        th1E2, c(0.00, 0.00, 0.00), c(61.659,  47.163,  26.637), XE2, n = 60, t.max = 600)$xi.best

#alternative c) to avoid negative lower bands, when the tuning parameter r=15
set.seed(123456789)
des.delta72.Big <- od_delta_KL_Example2(th0E2, c(0.6138981, 0.1170428, 0.2155228), c(59.90923, 91.91290, 50.99792), 
                                        th1E2, c(3.779729, 2.371618,  1.143619), c(38.17738, 30.72232, 28.05011), XE2, n = 60, t.max = 600)$xi.best
